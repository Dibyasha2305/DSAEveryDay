<h2><a href="https://www.geeksforgeeks.org/problems/ways-to-tile-a-floor5836/1?page=2&category=Recursion&sortBy=submissions">Ways To Tile A Floor</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a floor of dimensions <strong>2 x n</strong> and tiles of dimensions <strong>2 x 1</strong>, the task is to find the <strong>number of ways</strong> the floor can be tiled. A tile can either be placed horizontally i.e as a 1 x 2 tile or vertically i.e as 2 x 1 tile.&nbsp;<br></span></p>
